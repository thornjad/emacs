...
- Native compilation is enabled by default, disable with =--without-native-compilation=
- Xwidgets support is enabled by default, disable with =--without-xwidgets=
